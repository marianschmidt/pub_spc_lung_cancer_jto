...
tab1_gt <- tab1_pre %>%
 ...
 #gt: Define row groups -> careful: you need to add groups in reverse order... so bottom group first
  ...
  tab_source_note(
    source_note = paste0(if(en_gb){"ASIR age-standardised incidence rate based on the European Standard Population 1976; "}else{"ASIR age-standardized incidence rate based on the European Standard Population 1976; "}, "DCO death-certificate only; ", "FU follow-up; ", "LC primary lung cancer; ", "NSCLC non-small-cell lung carcinoma; ", "PYAR person-years at risk; ", "SPC second primary cancer")
  ) %>% 
  #special formatting
...
### SXX. Table: Sensitivity analysis - Incidence of SPC in smoking-related sites for DCO < 10% regions
...
### S10. Table: Risk of smoking-related cancer in comparison to other definitions and to England and the US
